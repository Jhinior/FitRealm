...
//       // Save the price to localStorage before sending to the API
//       localStorage.setItem('programDetails', JSON.stringify(parsedCart));
//       console.log('Updated programDetails with price:', parsedCart);
...
//               // Save the price again to localStorage just before sending the API request
//           const storedCart = localStorage.getItem('programDetails');
//           if (storedCart) {
//             const parsedCart = JSON.parse(storedCart);
//             console.log('Sending price to the API:', parsedCart.price);
//           }
...
//           // Extract price and id from the response and print them
//           const { id } = data;
