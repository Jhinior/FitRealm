...
const onSubmit = async (values, actions) => {
  try {
    ...
    formData.append("passwd", values.passwd);
    formData.append("confirmpasswd", values.confirmpasswd);
    formData.append("sign_gender", values.sign_gender);
    formData.append("photo", values.photo);
    formData.append("certificate", values.certificate); // Append the certificate file

    const response = await Trainer_Signup(formData, url);
...
const TrainerSignup = () => {
  ...
  const {
    ...
    initialValues: {
      ...
      sign_gender: "",
      photo: null,
      certificate: null, // Add this line
    },
    validationSchema: TrainerSignupSchema,
    onSubmit,
  });
      ...
      <div className="trainer-container">
        ...
        <div className="col-md-12 cardd signup-form">
          <form onSubmit={handleSubmit} className="box">
            ...
            <label className="custom-file-upload">
              <input type="file" id="certificate" onChange={handleCertificateChange} />
              Your Certificate
            </label>
            <input
              type="submit"
